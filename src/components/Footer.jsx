...
export const Footer = () => {
  return (
    <footer className="bg-[#8FD4C6] py-16 px-6 flex flex-col items-center">
      <img className="h-10 mb-10" src={logo} alt="logo" />
      <ul className="flex gap-14 font-Barlow text-Dark-moderate-cyan font-bold tex-lg mb-14">
      ...
      <ul className="flex gap-7 items-center">
        <li className="cursor-pointer">
          <a href="#">
            {/* other way to use svg and change the color */}
            <svg
